...
-- Count the employees based on gender
SELECT gender, count(*)
FROM employee 
GROUP BY gender;

-- Find the sum of salaries of each department
SELECT department, SUM(salary)
FROM employee
GROUP BY department;

-- Find out the max and min salaries of each department
SELECT department, MAX(salary), MIN(salary)
FROM employee
GROUP BY department;

-- Find out the max and min salaries of each gender
SELECT gender, MAX(salary), MIN(salary)
FROM employee
GROUP BY gender;

-- Count the employees based on gender under HR department
SELECT gender, count(*)
FROM employee 
WHERE department = 'HR'
GROUP BY gender;
...
-- If you have different clauses in a single query
-- follow -> SELECT - FROM - WHERE - GROUP BY - HAVING - ORDER BY
-- EX: Finding out the average salaries of all male employees across each department and keeping only those departments
-- with avg salary > 60000 and ordering the result in descending order of department namee
...
INSERT INTO course VALUES(447, 'C Language', 180, 6000);
INSERT INTO course VALUES(571, 'Java', 220, 8000);
INSERT INTO course VALUES(697, 'Python', 200, 7000);
...
INSERT INTO student VALUES(1, 'Alice', 'AEC', 'CSE', 447);
INSERT INTO student VALUES(2, 'Bob', 'ACET', 'IT', 571);
INSERT INTO student VALUES(3, 'Charlie', 'ACOE', 'ECE', 447);
INSERT INTO student VALUES(4, 'Daniel', 'ACET', 'CSE', 991);
...
SELECT student.name AS s_name, course.name AS c_name
FROM
student 
JOIN
course
